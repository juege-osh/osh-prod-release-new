...
public interface ReleaseChangeService {
    ...
    ReleaseChangeDetailDTO analyzeItem(Long changeId, Long itemId);
    ReleaseChangeDetailDTO dryRunItem(Long changeId, Long itemId, ReleaseItemOperationRequest request);
    ReleaseChangeDetailDTO executeItem(Long changeId, Long itemId, ReleaseItemOperationRequest request);
    ReleaseChangeDetailDTO verifyItem(Long changeId, Long itemId, ReleaseItemOperationRequest request);
    ReleaseChangeDetailDTO rollbackItem(Long changeId, Long itemId, ReleaseItemOperationRequest request);
